    ...
    const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `Se você se encontra com dúvidas do que eu posso fazer dirija-se rapidamente a um chat de comandos e digite: ${prefix}ajuda\n\n` +
          `<a:charmander:594967880311767290> Suporte: [Clique aqui](https://discord.gg/qrZ4HuY)`
      )
...
client.on("guildDelete", guild => {
  ...
  let embedsaida = new Discord.RichEmbed()
    ...
    .setThumbnail(icon)
    .setTitle(
      `**Acabei de sair de um servidor :voltaHXZ:** \`${guild.name}\``,
      true
    )
    .addField(`**Nome do servidor**`, `\`${guild.name}\``, true)
    .addField(`**Id do servidor**`, `\`${guild.id}\``, true)
...
client.on("guildCreate", guild => {
  const mensagem = new Discord.RichEmbed()
    ...
    .addField(
      ...
      `**[Entre em meu servidor https://discord.gg/qrZ4HuY](https://discord.gg/qrZ4HuY)**`
    )
    .setColor("#000000")
